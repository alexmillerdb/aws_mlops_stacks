...
Opening a pull request will trigger a[workflow](../.github/workflows/aws_mlops_stacks-run-tests.yml) 
...
Links:
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/aws_mlops_stacks/aws_mlops_stacks-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/aws_mlops_stacks/aws_mlops_stacks-model)
. 
