...
git add README.md docs .gitignore aws_mlops_stacks/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[aws_mlops_stacks/databricks.yml](../aws_mlops_stacks/databricks.yml) file.
...
Follow the instructions in [aws_mlops_stacks/resources/README.md](../aws_mlops_stacks/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../aws_mlops_stacks/resources/README.md)  to propose, test, and deploy
