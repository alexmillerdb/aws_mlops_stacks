...
```
aws_mlops_stacks        <- Root directory. Both monorepo and polyrepo are supported.
│
├── aws_mlops_stacks       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
...
the [project README](./aws_mlops_stacks/README.md).
...
After that, follow the [ML pull request guide](docs/ml-pull-request.md)
 and [ML resource config guide](aws_mlops_stacks/resources/README.md)  to propose, test, and deploy changes to production ML code (e.g. update model parameters)
or pipeline resources (e.g. use a larger instance type for model training) via pull request.

| Role                          | Goal                                                                         | Docs                                                                                                                                                                |
|-------------------------------|------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Data Scientist                | Get started writing ML code for a brand new project                          | [project README](./aws_mlops_stacks/README.md) |
...
| Data Scientist                | Modify production model ML resources, e.g. model training or inference jobs  | [ML resource config guide](aws_mlops_stacks/resources/README.md)  |
...
need to run it again for project `aws_mlops_stacks`.
