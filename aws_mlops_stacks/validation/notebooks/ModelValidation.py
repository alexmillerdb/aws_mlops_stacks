...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``aws_mlops_stacks/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in aws_mlops_stacks/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in aws_mlops_stacks/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-aws_mlops_stacks-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.alex_m_mlops_stacks.aws_mlops_stacks-model", "Full (Three-Level) Model Name")
