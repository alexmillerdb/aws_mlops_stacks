...
dbutils.widgets.text(
    "model_name", "dev.alex_m_mlops_stacks.aws_mlops_stacks-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.alex_m_mlops_stacks.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.alex_m_mlops_stacks.trip_dropoff_features",
    label="Dropoff Features Table",
)

dbutils.widgets.text("output_table_path", "dev.alex_m_mlops_stacks.feature_store_inference_input")
